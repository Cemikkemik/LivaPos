...
$config[ 'tables_to_backup' ]			=	array( 'nexo_arrivages', 'nexo_articles', 'nexo_categories', 'nexo_clients', 'nexo_clients_groups', 'nexo_commandes', 'nexo_commandes_produits', 'nexo_fournisseurs', 'nexo_historique', 'nexo_paiements', 'nexo_premium_factures', 'nexo_rayons', 'nexo_types_de_commandes' );
