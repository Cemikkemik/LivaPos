...
include_once(APPPATH . '/modules/nexo_restaurant/inc/traits_loader.php'); // Include from Nexo module dir

use Carbon\Carbon;

class Restaurant extends REST_Controller
{
    use Nexo_Restaurant_Print_Trait,
		Nexo_Restaurant_Orders,
		Nexo_Restaurant_Tables_Trait;
