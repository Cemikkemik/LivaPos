...
class license_key{  
	...
	var $isvalid=true; //returns this value for valid keys
	var $invalid=false; //returns this value for invalid keys
	var $software="Nexo"; //name of software for which key is to be generated
