...
class Nexo_Restaurant_Install extends Tendoo_Module
{
    ...
    **/
    ...
    public function delete_tables( $table_prefix = '' )
    {
        ...
        if( $this->db->table_exists( $table_prefix . 'nexo_commandes_produits' ) ) {
