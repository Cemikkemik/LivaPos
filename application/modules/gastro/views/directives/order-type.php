        ...
        return {
            ...
            controller          :   [ '$scope', '$timeout', function( $scope, $timeout ) {
                $timeout( function(){
                    ...
                    $( '.order-type-box' ).find( '.modal-footer' ).prepend( '<a href="<?php echo site_url([ 'dashboard', store_slug(), 'nexo', 'commandes', 'lists']);?>" class="btn btn-warning"><?php echo _s( 'Exit', 'gastro' );?></a>' );
