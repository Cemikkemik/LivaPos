...
$scope.openStripePayment	=	function(){
    ...
    $scope.stripeDetails	=	{
    	name				:	'<?php echo _s( 'Paiement d\'une commande', 'nexo' );?>',
        description			:	'<?php echo sprintf( _s( 'Vous venez d\'effectuer un paiement dans la boutique %s. Merci', 'nexo' ), $Options[ store_prefix() . 'site_name' ] );?>',
