	...
	**/
	...
	public function add_fields( $fields )
	{
		...
		if( $PageNow	==	'nexo/produits' ) {
			...
			$field_minutes	=	new stdClass;
			$field_minutes->field_name		=	'NP_MINUTES';
			$field_minutes->display_as		=	__( 'Minutes', 'nexo-playground-manager' );
			$field_minutes->description	=	tendoo_info( __( 'You can set how many minutes you would like to add to the order.', 'nexo-playground-manager' ) );

			$fields[]	=	$field_minutes;
		}
