<div ng-show="selectedTable != false" class="col-lg-5 col-md-5 col-xs-6 col-sm-6" style="height:{{ wrapperHeight }}px">
    ...
    <div ng-show="selectedTable.STATUS != 'out_of_use'">
        ...
        <keyboard ng-show="selectedTable.STATUS != 'in_use'" input_name="used_seat" keyinput="keyboardInput" hide-side-keys="hideSideKeys" hide-button="hideButton"/>
    </div>
    ...
    <div class="btn-group btn-group-lg">
        ...
        <button ng-click="cancelTableSelection()" type="button" class="btn btn-default"><?php echo __( 'Show Areas', 'nexo-restaurant' );?></button>
...
<div ng-show="selectedTable === false" class="col-lg-2 col-md-2 col-sm-3 col-xs-3 bootstrap-tab-menu">
    ...
    <div class="list-group">
        <a ng-class="{ 'active' : room.active }" ng-click="loadRoomAreas( room )" ng-repeat="room in rooms" class="text-left list-group-item" href="javascript:void(0)" style="margin: 0px; border-radius: 0px; border-width: 0px 0px 1px 1px; border-style: solid; border-bottom-color: rgb(222, 222, 222); line-height: 30px;">{{ room.NAME }}</a>
        <a ng-show="rooms.length == 0" class="text-left list-group-item" href="javascript:void(0)" style="margin: 0px; border-radius: 0px; border-width: 0px 0px 1px 1px; border-style: solid; border-bottom-color: rgb(222, 222, 222); line-height: 30px;"><?php echo __( 'No Rooms available', 'nexo-restaurant' );?></a>
    </div>
</div>
<div ng-show="selectedTable === false" class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bootstrap-tab-menu" style="height:{{ wrapperHeight }}px;border-left:solid 1px #EEE;">
    <div class="text-center">
        <h4><?php echo __( 'Select an Area', 'nexo-restaurant' );?></h4>
    </div>
    <hr style="margin:0px;">
    <div class="list-group">
        <a ng-class="{ 'active' : area.active }" ng-click="loadTables( area )" ng-repeat="area in areas" class="text-left list-group-item" href="javascript:void(0)" style="border-left:0px solid transparent;margin: 0px; border-radius: 0px; border-width: 0px 0px 1px 1px; border-style: solid; border-bottom-color: rgb(222, 222, 222); line-height: 30px;">{{ area.AREA_NAME }}</a>
        <a ng-show="areas.length == 0" class="text-left list-group-item" href="javascript:void(0)" style="margin: 0px; border-radius: 0px; border-width: 0px 0px 1px 1px; border-style: solid; border-bottom-color: rgb(222, 222, 222); line-height: 30px;"><?php echo __( 'No Areas available', 'nexo-restaurant' );?></a>
    </div>
    <the-spinner spinner-obj="spinner" namespace="areas"/>
</div>
<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6" style="height:{{ wrapperHeight }}px;border-left:solid 1px #EEE;overflow-y:scroll">
    <div class="text-center">
    ...
    <div class="row">
        <br>
        <div class="col-md-4 text-center table-animation {{ getTableColorStatus( table ) }}" ng-click="selectTable( table )" ng-repeat="table in tables">
            <div class="">
                ...
                <p class="text-center">{{ table.TABLE_NAME }}</p>
            </div>
        </div>
    </div>
