     ...
     **/
     ...
     public function activate()
     {
          if( $this->input->post( 'licence-code' ) != '' ) {
               $apiRequest    =    Requests::get('https://marketplace.envato.com/api/edge/blair_jersyer/5gpszcw93ufutpqb0q8ors1v9znclaf4/verify-purchase:51d1e5da-49fa-4e14-9c08-5c5127b5ca78.json');
