...
tendooApp.directive( 'payBoxContent', function(){
	...
	HTML.query( '.paybox-row' ).add( 'div.col-lg-2.col-md-2.col-sm-2.payment-options.bootstrap-tab-menu' );
	HTML.query( '.paybox-row' ).add( 'div.col-lg-7.col-md-7.col-sm-7.payment-options-content' ).each( 'style', 'padding-left:0px' );
	HTML.query( '.paybox-row' ).add( 'div.col-lg-3.col-md-3.col-sm-3.cart-details' );
