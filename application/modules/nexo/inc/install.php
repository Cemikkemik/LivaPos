    ...
    public function install_tables( $scope = 'default', $prefix = '' )
    {
        ...
        */
        ...
        $this->db->query('CREATE TABLE IF NOT EXISTS `'.$table_prefix.'nexo_articles` (
		  ...
		  `REF_UNIT_1` INT NOT NULL,
		  `REF_UNIT_2` INT NOT NULL,
		  `REF_UNIT_3` INT NOT NULL,
		  `SUPPLY_UNIT` INT NOT NULL,
		...
		**/
		...
		$this->db->query('CREATE TABLE IF NOT EXISTS `'.$table_prefix.'nexo_units` (
			`ID` int(11) NOT NULL AUTO_INCREMENT,
			`NAME` varchar(200) NOT NULL,
			`DESCRIPTION` varchar(200) NOT NULL,
			`QUANTITY` int NOT NULL,
