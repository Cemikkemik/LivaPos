  ...
  <div class="box box-widget widget-user-2" data-meta-namespace="nexo_profile">
    ...
    <div class="box-footer no-padding">
      <ul class="nav nav-stacked">
        <li><a href="javascript:void(0)"><?php _e('Ventes réalisées ce mois', 'nexo');?> <span class="pull-right sales_numbers_this_month"><?php echo intval(@$Report[ 'sales_numbers_this_month' ]);?></span></a></li><!-- badge bg-blue  -->
        <li><a href="javascript:void(0)"><?php _e('Ventes générales', 'nexo');?> <span class="pull-right sales_numbers"><?php echo intval(@$Report[ 'sales_numbers' ]);?></span></a></li><!-- badge bg-blue  -->
        <li>
