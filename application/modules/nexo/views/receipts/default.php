                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="" style="text-align: right"> <?php echo $_produit[ 'QUANTITE' ];?> </td>
                            <td class="text-right">
                            <?php echo $this->Nexo_Misc->display_currency( 'before' );?>
                        ...
                        <?php
						$terme		=	intval( $Options[ 'nexo_order_comptant' ] ) == intval( $order[ 'order' ][0][ 'TYPE' ] ) ? __( '&Agrave; rembourser :', 'nexo' ) : __( '&Agrave; percevoir :', 'nexo' );
						?>
                        <tr>
