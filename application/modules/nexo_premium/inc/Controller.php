...
class Nexo_Premium_Controller extends CI_Model
{
	...
	**/
	...
	function Controller_Stats_Des_Ventes( $year = NULL )
	{
	...
	**/
	...
	function Controller_Fiche_De_Suivi( $shipping_one = NULL, $shipping_two = NULL )
	{
	...
	**/
	...
	function __Facture_Create( $data )
	{
		$data[ 'AUTHOR'	]			=	User::id();
	...
	**/
	...
	function __Facture_Update( $data ) 
	{
		$data[ 'AUTHOR'	]				=	User::id();
	...
	**/
	...
	function Controller_Factures( $page )
	{
	...
	**/
	...
	function Controller_Clear_Cache( $id )
	{
	...
	**/
	...
	function Controller_Stats_Caissier( $start_date = NULL, $end_date = NULL ) 
	{
	...
	**/
	...
	function Controller_Stats_Clients( $start_date = NULL, $end_date = NULL ) 
	{
		$this->load->model( 'Nexo_Misc' );
