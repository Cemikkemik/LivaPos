...
$Route->get( '/nexo/reports/daily-sales/{date?}', 'NexoPremiumController@daily' );
...
$Route->get( '/nexo/reports/expenses/{start_date?}/{end_date?}', 'NexoPremiumController@profit_and_losses' );
