...
var RunQueries		=	function(){
	$.ajax( '<?php echo site_url( array( 'nexo_premium', 'run_restore_query' ) );?>' + '/' + currentIndex, {
		success		:	function( value ) {
			if( currentIndex < ( totalQueries - 1 ) ) {
				...
				setTimeout( function(){
					...
					$( '.query_status' ).after( '<div class="restore_notice"><?php echo addslashes( $this->lang->line( 'restore_successful' ) );?></p>' ); 
				}, 2000 );
			}
		}
	});
